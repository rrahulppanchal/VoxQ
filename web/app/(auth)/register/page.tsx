...
import { LockKeyhole, LogIn, Mail, Search, User, UserPlus, UserRoundCog } from 'lucide-react';
  ...
  return (
    <div className="h-[100vh] flex items-center justify-center">
      <div className="w-96 p-10 border rounded-md flex gap-5 flex-col">
        <span className="text-2xl font-bold mb-5	text-center">Register to VoxQ</span>
        ...
        <div className="relative">
          <LockKeyhole className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground" />
          <Input placeholder="Confirm Password" type="password" className="pl-8" />
        </div>
